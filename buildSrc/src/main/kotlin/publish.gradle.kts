    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/ashtanko/androidbaseskeleton/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/ashtanko/androidbaseskeleton.git")
                    developerConnection.set("scm:git:ssh://github.com/ashtanko/androidbaseskeleton.git")
                    url.set("https://github.com/ashtanko/androidbaseskeleton/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/ashtanko/androidbaseskeleton/issues")
                }
            }
        }
    }
